...
// --- YOOKASSA KEY STUBS (FOR TESTING WITHOUT .ENV) ---
//
process.env.YOO_KASSA_SHOP_ID = '1207275';
//
process.env.YOO_KASSA_SECRET_KEY = 'test_ZriKtsrjLumdog892GJCPy1O5p4L29sV_dni09HxEys';
//
process.env.YOO_KASSA_SUCCESS_URL = 'http://localhost:3000/profile/tickets?status=success';
process.env.YOO_KASSA_CANCEL_URL = 'http://localhost:3000/profile/tickets?status=cancelled';
// -----------------------------------------------------------
